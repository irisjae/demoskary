...
var _estimate_no_idea = {};
var _estimate_invalidated = {};
								...
								inquiries
									.thru (tap, function (_inquiry) {
										states_init .then (function () {
											...
											var _estimate = (estimate || constant (_estimate_no_idea)) (item);
											var _request = request (item);
											
											var prev = states ();
											var curr = like (prev || {});
											
											if (_estimate !== _estimate_no_idea)
												curr .estimate =	{
																		label: id,
																		item: _estimate
																	};
...
var inquire_last =	function (stateful) {
						...
						if (_state &&
								! (_state .estimate && _state .estimate .item === _estimate_invalidated) &&
								_state .value)
