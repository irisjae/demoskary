...
var mock_loggined_in_api =	make (function (self) {
								var mock =	R. pipe (
												R .applySpec ({
													json: R .identity
												}),
								...
								self .matches_to_find = stateful ({
									...
									fetch: mock ({
									    "result": {
									        "match_list": [{
									            "id": "1",
									            "start_at": "2017-06-19T11:30:00Z",
									            "end_at": "2017-06-19T13:00:00Z",
									            ...
									            "id": "1",
									            "start_at": "2017-06-20T11:30:00Z",
									            "end_at": "2017-06-20T13:00:00Z",
								...
								self .match_to_find_info = function (match_id) {
									return stateful ({
										key: ':user:' + user_id + ':match:' + match_id + ':match-to-find-info',
										per: 'lump',
										request: R .applySpec ({
								...
								self .match_open = function (team_id) {
									return stateful ({
										key: ':user:' + user_id + ':team:' + team_id + ':match-open',
										per: 'none',
										request: R .applySpec ({
								...
								self .match_apply = function (team_id, match_id) {
									return stateful ({
										key: ':user:' + user_id + ':team:' + team_id + ':match:' + match_id + ':match-apply',
										per: 'none',
										request: R .applySpec ({
								...
								self .match_applications = function (team_id, match_id) {
									return stateful ({
										key: ':user:' + user_id + ':team:' + team_id + ':match:' + match_id + ':match_applications',
										per: 'lump',
										request: R .applySpec ({
								...
								self .matches = function (team_id) {
									return stateful ({
											key: ':user:' + user_id + ':team:' + team_id + ':matches',
											per: 'lump',
											request: R .applySpec ({
												path: constant (backend_path + '/me/team/' + team_id + '/match'),
												method: constant ('GET'),
								...
								self .matches_applied = function (team_id) {
									return stateful ({
										key: ':user:' + user_id + ':team:' + team_id + ':matches-applied',
										per: 'lump',
										request: R .applySpec ({
...
var api = stream (mock_loggined_in_api);
